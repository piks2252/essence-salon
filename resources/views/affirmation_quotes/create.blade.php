        ...
        <div class="panel panel-flat">
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    @include('errors.list')
                    <div class="col-lg-12">
                        <form role="form" name="quote_form" id="quote_form" method="post" action="{{ route('affirmation-quote.store') }}">
                            @csrf
                            <fieldset class="form-horizontal form-validate-jquery">
                                <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea class="form-control" name="message" id="message" rows=5 placeholder="Enter Message">{{old('message')}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-12">
