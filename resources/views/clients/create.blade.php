...
@section('head_script')
    ...
    <script type="text/javascript" src="{{ asset('assets/js/plugins/validation/clients.js') }}"></script> 
        ...
        <div class="page-header page-header-default">
            <div class="page-header-content">
                <div class="page-title">
                    <h4>{{(isset($data))?'Edit':'Add'}} Client</h4>
                </div>
            </div>
        </div>
        <div class="panel panel-flat">
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    @include('errors.list')
                    <div class="col-lg-12">
                        <form role="form" name="client_form" id="client_form" method="post" action="{{(isset($data)) ? route('clients.update',$data->id) : route('clients.store') }}">
                            @csrf
                            ...
                            <fieldset class="form-horizontal form-validate-jquery">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">Date of aniversary
                                            </label>
                                            <div class="col-lg-8">
                                                <input type="text" id="doa" name="date_of_aniversary" class="form-control datepicker" value="{{(isset($data->date_of_aniversary))? $data->date_of_aniversary : old('date_of_aniversary') }}"  placeholder="Select Date of aniversary">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-12">
