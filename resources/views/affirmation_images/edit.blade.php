        ...
        <div class="panel panel-flat">
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    @include('errors.list')
                    <div class="col-lg-12">
                        <form role="form" name="image_form" id="image_form" class="edit-form" method="post" action="{{ route('affirmation-image.update',$affirmation_image->id) }}" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PUT') }}
                                ...
                                <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div style="padding:10px" id="imgContainer">
                                                    <img src="{{ asset('assets/images/affirmation-images/'.$affirmation_image->image_path) }}" class="img-responsive img-circle" style="height:100px; width:100px;" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
