        ...
        <div class="panel panel-flat">
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    @include('errors.list')
                    <div class="col-lg-12">
                        <form role="form" name="category_form" id="category_form" method="post" action="{{ route('categories.store') }}">
                            @csrf
                            <fieldset class="form-horizontal form-validate-jquery">
                                <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="{{old('message')}}" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-12">
