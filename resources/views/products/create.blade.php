        ...
        <div class="panel panel-flat">
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    @include('errors.list')
                    <div class="col-lg-12">
                        <form role="form" name="product_form" id="product_form" method="post" action="{{ route('products.store') }}">
                            @csrf
                            <fieldset class="form-horizontal form-validate-jquery">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="js-example-basic-single" name="company_id" style="width:100%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="color" id="color" placeholder="Enter color" value="{{ old('color') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="watt" id="watt" placeholder="Enter watt" value="{{ old('watt') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Dimention</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="dimention" id="dimention" placeholder="Enter dimention" value="{{ old('dimention') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Lumens Output</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="lumens_output" id="lumens_output" placeholder="Enter lumens_output" value="{{ old('lumens_output') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Beam Angle</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="beam_angle" id="beam_angle" placeholder="Enter beam angle" value="{{ old('beam_angle') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="body_colour" id="body_colour" placeholder="Enter body colour" value="{{ old('body_colour') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Quantity</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="quantity" id="quantity" placeholder="Enter quantity" value="{{ old('quantity') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="price" id="price" placeholder="Enter price" value="{{ old('price') }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-12">
